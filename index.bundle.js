...
const displayTasks = (array) => {
    ...
    array.forEach(task => {
        ...
        date.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(task.date, 'dd-MM-yyyy');
