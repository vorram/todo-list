...
/* harmony import */ var date_fns_set__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns/set */ "./node_modules/date-fns/esm/set/index.js");
...
const createTask = () => {
    ...
    allTasks.sort(function(a, b) {
        return (0,date_fns_compareAsc__WEBPACK_IMPORTED_MODULE_1__["default"])(a.date, b.date);
    });
};
...
const displayToday = () => {
    ...
    allTasks.forEach(task => {
        if ((0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(task.date, 'dd-MM-yyyy') === (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'dd-MM-yyyy')) {
...
const displayTomorrow = () => {
    clearArrays();
    let tomorrow = (0,date_fns_add__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), {days: 1});
    allTasks.forEach(task => {
        if ((0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(task.date, 'dd-MM-yyyy') === (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(tomorrow, 'dd-MM-yyyy')) {
...
const displayWeek = () => {
    clearArrays();
    let week = (0,date_fns_add__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), {weeks: 1});
    allTasks.forEach(task => {
        if ((0,date_fns_isWithinInterval__WEBPACK_IMPORTED_MODULE_4__["default"])(task.date, {
            start: (0,date_fns_set__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), {hours: 0, minutes: 0, seconds: 0}),
            end: week
        })) {
            weekArray.push(task);
        }
...
const displayMonth = () => {
    clearArrays();
    let month = (0,date_fns_add__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), {months: 1});
    allTasks.forEach(task => {
        if ((0,date_fns_isWithinInterval__WEBPACK_IMPORTED_MODULE_4__["default"])(task.date, {
            start: (0,date_fns_set__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), {hours: 0, minutes: 0, seconds: 0}),
            end: month
...
const displayTasks = (array) => {
    ...
    array.forEach(task => {
        ...
        date.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(task.date, 'dd-MM-yyyy');
